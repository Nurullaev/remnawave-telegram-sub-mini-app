import {
    EncryptHappCryptoLinkCommand, GetSubpageConfigByShortUuidCommand,
    GetSubscriptionInfoByShortUuidCommand,
    GetUserByTelegramIdCommand, REMNAWAVE_REAL_IP_HEADER,
...
export async function POST(request: Request) {
    ...
    try {
        ...
        return new Response(JSON.stringify({...response, subpageConfigUuid: subpageConfig.data.response.subpageConfigUuid}), { status: 200 })
    } catch (error) {
